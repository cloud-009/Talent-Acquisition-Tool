...
export class TimelineComponent implements OnInit {
  ...
  constructor(
    ...
    private service: RequistiondataService, public dialog: MatDialog) { }
  ...
  getRequisitionEvents() {
    this.jsonData.forEach((data: any) => {
      ...
      let startDate = data.raisedFDate;
      let endDate = data.raisedTDate;
      this.eventsDate.push({
        id: data.id, title: data.jobTitle, primary: data.primary,
        start: startDate,
        end: endDate,
        backgroundColor: backgroundColor,
        status: statusOfRequisition,
  ...
  getCalendarOptions() {
    this.calendarOptions = {
      ...
      eventDidMount(model: any): void {
        let primary: any = model.event._def.extendedProps.primary;
        model.el.innerHTML += `${primary}`
      }
    };
  }
  ...
  handleEventClick(event: any) {
    let id: any = event.event._def.publicId;
    this.router.navigate([`/jobs/reqdet/${event}/jobdet`], { queryParams: { id: id } });
  }
