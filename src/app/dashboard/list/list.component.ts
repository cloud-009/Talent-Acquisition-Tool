...
export class ListComponent implements OnInit {
  ...
  constructor(private reqService: RequistiondataService, private router: Router) { }

  ngOnInit(): void {
    this.getListData();
  }

  clickHideList(id: number) {
    let element = this.jsonData.find((x: any) => x.id === id);
    element.hideContent = !element.hideContent;
  }
  ...
  getListData() {
    this.jsonData.forEach((data: any) => {
      ...
      let jsonObject = { data: data, status: statusOfRequisition }
